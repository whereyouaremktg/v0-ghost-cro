...
export function PipelineStatus() {
  return (
    <div className="rounded-xl border border-zinc-200 bg-white shadow-sm p-6 h-full flex flex-col">
      {/* Header */}
      <div className="text-[10px] font-bold uppercase tracking-wider text-zinc-400 mb-6">
      ...
      <div className="flex items-center justify-between flex-1">
        <div className="flex items-center gap-6 flex-1">
          ...
          <div className="flex-1 flex items-center">
            <div className="w-full border-t-2 border-dotted border-zinc-200"></div>
          </div>

          {/* Node 2: Ghost AI */}
          <div className="flex flex-col items-center gap-2">
            <div className="h-12 w-12 rounded-lg border-2 border-zinc-300 bg-white flex items-center justify-center relative">
              <Bot className="h-6 w-6 text-zinc-800" />
              {/* Pulse effect */}
              <span className="absolute inset-0 rounded-lg bg-zinc-800 opacity-20 animate-ping"></span>
            </div>
            <span className="text-xs font-medium text-zinc-900">Analysis</span>
          </div>
