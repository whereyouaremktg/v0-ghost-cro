          ...
          <div className="flex items-center gap-2 text-sm">
            <div className="flex-1 h-3 border-2 border-border bg-card">
              <div
                ...
                style={{ width: `${(mockUser.testsUsed / mockUser.testsLimit) * 100}%` }}
              />
            </div>
            <span className="font-mono text-xs font-bold">
              {mockUser.testsUsed}/{mockUser.testsLimit}
            </span>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          {userMenuOpen && (
            <div className="absolute bottom-full left-0 right-0 mb-2 bg-card border-2 border-border brutal-shadow">
              <button className="w-full flex items-center gap-2 px-4 py-3 text-sm font-medium hover:bg-muted text-left">
