      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border-2 border-border brutal-shadow-lg p-8">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-foreground font-bold uppercase tracking-wide text-sm border-2 border-border brutal-shadow brutal-hover"
            >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-card text-muted-foreground font-bold uppercase">
                Secure Login
              </span>
            </div>
          </div>
